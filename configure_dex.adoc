...
*** For `rootCAData:` follow the instructions to base64 encode the root CA Certificate
**** Insert one space and the encoded certificate
...
**** Search for `grep ^dn:\ cn=$USERNAME $FILENAME`
