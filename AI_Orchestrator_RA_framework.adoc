...
:ProductNameNoSpaces: AI-Orchestrator
...
include::https://github.com/alexarnoldy/_includes/blob/master/IHV/{IHVPartner}/{susedoctypenospaces}-{CompanyName}-{ProductNameNoSpaces}-BOM.adoc[]
