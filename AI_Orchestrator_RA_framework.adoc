...
include::https://github.com/alexarnoldy/_includes/IHV/{IHVPartner}/{IHVPlatform}.adoc[]

include::https://github.com/alexarnoldy/_includes/blob/master/IHV/Dev_Null/DN-100-Compute.adoc
